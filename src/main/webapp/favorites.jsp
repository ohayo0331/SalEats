...
window.onload=function() {
	...
	if (userName != "Guest") {
		$.ajax({url: "FavoritesServlet", data: {resID: "", userName: userName}, success: function(result){ 
...
<title>Sal Eats Favorites</title>
</head>
<body>
<!-- Navigation bar -->
...
<div class="container Search-container">
	...
	<script type="text/javascript">
		...
		var userNameCap = document.createElement("h2");
		userNameCap.id = "searchCap";
		var userName = getCookie("userName");
		if (userName != "Guest") {
			userNameCap.innerHTML = userName + "'s Favorites: ";
		} else {
			userNameCap.innerHTML = "Please sign in to see your favorites";
		}
		caption.append(userNameCap);
	</script>
	</div>
	<hr class="dividingLine">
</div>
